...
export default function StandardProductsMasterTab() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900">商品資料主檔</h2>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {uploadResult && (
            <div className={`flex items-center gap-2 text-sm px-3 py-1.5 rounded-lg ${
              ...
              {uploadResult.success ? <CheckCircle className="w-4 h-4 shrink-0" /> : <AlertCircle className="w-4 h-4 shrink-0" />}
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-100">
            ...
            {products.map((product) => (
              <div key={product.product_code} className="grid grid-cols-12 px-5 py-3 text-sm items-center hover:bg-gray-50">
                <div className="col-span-3 font-mono text-gray-700">{product.product_code}</div>
                <div className="col-span-6 text-gray-900">{product.product_name}</div>
                <div className="col-span-2 text-gray-500">{product.unit || '—'}</div>
