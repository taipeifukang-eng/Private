-- 更新獎金區塊計算邏輯：上班天數為0時歸類到區塊3
-- 執行日期: 2026-01-XX

-- 更新 calculate_bonus_block 函數，加入 p_work_days 參數
...
-- 重新計算所有上班天數為0的正職員工的區塊
UPDATE monthly_staff_status
SET calculated_block = 3,
