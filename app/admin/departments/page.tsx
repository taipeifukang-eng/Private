...
export default async function DepartmentsPage() {
  ...
  const [
    ...
    hasAnyPermission(user.id, ORGANIZATION_DEPARTMENT_WORKSPACE_VIEW_PERMISSION_CODES),
    hasAnyPermission(user.id, ORGANIZATION_DEPARTMENT_CREATE_PERMISSION_CODES),
    hasAnyPermission(user.id, ORGANIZATION_DEPARTMENT_WORKSPACE_MANAGE_PERMISSION_CODES),
